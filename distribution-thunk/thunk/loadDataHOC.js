...
var multiple = exports.multiple = function multiple(entity, dataRetriever) {
  return function (WrappedComponent) {
    ...
    function mapDispatchToProps(dispatch) {
      ...
      return (0, _redux.bindActionCreators)((_bindActionCreators = {}, _defineProperty(_bindActionCreators, 'load' + Utils.capitalize(entity), Core.getLoadEntitysAction(entity)), _defineProperty(_bindActionCreators, 'loadMore' + Utils.capitalize(entity), function undefined(q) {
        return function (dispatch) {
          return dispatch(Core.getLoadEntitysAction(entity)(q, true));
        };
...
var single = exports.single = function single(entity, idRetriever) {
  return function (WrappedComponent) {
    ...
    function mapDispatchToProps(dispatch) {
      return (0, _redux.bindActionCreators)(_defineProperty({}, loadEntityFuncName, Core.getLoadEntitysAction(entity, true)), dispatch);
    }
